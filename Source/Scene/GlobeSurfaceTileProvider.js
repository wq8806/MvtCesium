define([
        ...
        if (!defined(this._renderState)) {
            this._renderState = RenderState.fromCache({ // Write color and depth
                cull : {
                    //enabled : true
                    //TS-GIS
                    enabled : frameState.camera._scene.underGroundMode === true ? false : true
                },
                depthTest : {
                    enabled : true,
    ...
    GlobeSurfaceTileProvider.prototype.computeTileVisibility = function(tile, frameState, occluders) {
        ...
        if (frameState.fog.enabled) {
            if (CesiumMath.fog(distance, frameState.fog.density) >= 1.0) {
                ...
                //TS-GIS
                return Visibility.FULL; //雾里的tile也正常显示
            }
        }
    ...
    function addDrawCommandsForTile(tileProvider, tile, frameState) {
        ...
        var terrainData = surfaceTile.terrainData;
        //TS-GIS
        /*if (defined(terrainData) && defined(terrainData.credits)&& defined(creditDisplay)) {
        ...
        //TS-GIS
        initialColor.w = tileProvider._globeAlpha;
        ...
        do {
            ...
            while (numberOfDayTextures < maxTextures && imageryIndex < imageryLen) {
                ...
                uniformMapProperties.dayTextureAlpha[numberOfDayTextures] = tileProvider._globeAlpha === 1.0 ? imageryLayer.alpha : tileProvider._globeAlpha;
                ...
                //TS-GIS
                if (defined(imagery.credits) && defined(creditDisplay)) {
            ...
            //TS-GIS
            command.pass = tileProvider._globeAlpha === 1.0 ? Pass.GLOBE : Pass.TRANSLUCENT;
