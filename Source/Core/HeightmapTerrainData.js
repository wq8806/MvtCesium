define([
    ...
    function HeightmapTerrainData(options) {
        ...
        this._skirtHeight = options.skirtHeight; //裙边高度  modify by weidong
    ...
    HeightmapTerrainData.prototype.createMesh = function(tilingScheme, x, y, level, exaggeration) {
        ...
        //TS-GIS
        //this._skirtHeight = Math.min(thisLevelMaxError * 4.0, 1000.0);//modify by weidong
        this._skirtHeight = this._skirtHeight === undefined ? Math.min(thisLevelMaxError * 4.0, 1000.0) : this._skirtHeight;
    ...
    HeightmapTerrainData.prototype.upsample = function(tilingScheme, thisX, thisY, thisLevel, descendantX, descendantY, descendantLevel) {
        ...
        return new HeightmapTerrainData({
            ...
            //TS-GIS
            skirtHeight : this._skirtHeight //裙边高度  add by weidong
        });
    };
