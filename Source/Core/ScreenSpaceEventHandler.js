define([
    ...
    //TS-GIS
    function registerListener(screenSpaceEventHandler, domType, element, callback, preEvent) {
        function listener(e) {
            callback(screenSpaceEventHandler, e, preEvent);
        }
    ...
    //TS-GIS
    function registerListeners(screenSpaceEventHandler, preEvent) {
        var element = screenSpaceEventHandler._element;
        ...
        if (FeatureDetection.supportsPointerEvents()) {
            registerListener(screenSpaceEventHandler, 'pointerdown', element, handlePointerDown, preEvent);
            registerListener(screenSpaceEventHandler, 'pointerup', element, handlePointerUp, preEvent);
            registerListener(screenSpaceEventHandler, 'pointermove', element, handlePointerMove, preEvent);
            registerListener(screenSpaceEventHandler, 'pointercancel', element, handlePointerUp, preEvent);
        } else {
            registerListener(screenSpaceEventHandler, 'mousedown', element, handleMouseDown, preEvent);
            registerListener(screenSpaceEventHandler, 'mouseup', alternateElement, handleMouseUp, preEvent);
            registerListener(screenSpaceEventHandler, 'mousemove', alternateElement, handleMouseMove, preEvent);
            registerListener(screenSpaceEventHandler, 'touchstart', element, handleTouchStart, preEvent);
            registerListener(screenSpaceEventHandler, 'touchend', alternateElement, handleTouchEnd, preEvent);
            registerListener(screenSpaceEventHandler, 'touchmove', alternateElement, handleTouchMove, preEvent);
            registerListener(screenSpaceEventHandler, 'touchcancel', alternateElement, handleTouchEnd, preEvent);
        }

        //TS-GIS
        registerListener(screenSpaceEventHandler, 'dblclick', element, handleDblClick, preEvent);
        ...
        //TS-GIS
        registerListener(screenSpaceEventHandler, wheelEvent, element, handleWheel, preEvent);
    }
    ...
    //TS-GIS
    function handleMouseDown(screenSpaceEventHandler, event, preEvent) {
    ...
    //TS-GIS
    function handleMouseMove(screenSpaceEventHandler, event, preEvent) {
        if (!canProcessMouseEvent(screenSpaceEventHandler)) {
            return;
        }
    ...
    //TS-GIS
    function handleWheel(screenSpaceEventHandler, event, preEvent) {
    ...
    //TS-GIS
    function fireTouchEvents(screenSpaceEventHandler, event, preEvent) {
        var modifier = getModifier(event);
        var positions = screenSpaceEventHandler._positions;
    ...
    //TS-GIS
    function fireTouchMoveEvents(screenSpaceEventHandler, event, preEvent) {
        var modifier = getModifier(event);
        var positions = screenSpaceEventHandler._positions;
        var previousPositions = screenSpaceEventHandler._previousPositions;
        var numberOfTouches = positions.length;
    ...
    //TS-GIS
    function handlePointerDown(screenSpaceEventHandler, event, preEvent) {
     ...
     */
    //TS-GIS
    function ScreenSpaceEventHandler(element, preEvent) {
        this._inputEvents = {};
        this._buttonDown = {
            LEFT: false,
            MIDDLE: false,
        ...
        //TS-GIS
        registerListeners(this, preEvent);
    }
