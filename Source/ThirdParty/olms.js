            ...
            (function (t) {
                ...
                w.prototype.parse = function (e, t, o) {
                    ...
                    var m = o.pathname && "/" === o.pathname.charAt(0),
                        g = e.host || e.pathname && "/" === e.pathname.charAt(0), v = g || m || o.host && e.pathname, b = v,
                        x = o.pathname && o.pathname.split("/") || [],
                ...
                function Ke(e) {
                    var t = He(e.r), o = He(e.g), r = He(e.b), i = $e((.4124564 * t + .3575761 * o + .1804375 * r) / Le),
                ...
                var Qe = {
                    forward: Ke, reverse: Ze, interpolate: function (e, t, o) {
                        return {l: Pe(e.l, t.l, o), a: Pe(e.a, t.a, o), b: Pe(e.b, t.b, o), alpha: Pe(e.alpha, t.alpha, o)}
                    }
                }, et = {
                    forward: function (e) {
                        ...
                        return {h: Xe(e.h, t.h, o), c: Pe(e.c, t.c, o), l: Pe(e.l, t.l, o), alpha: Pe(e.alpha, t.alpha, o)}
                    }
                ...
                function Et(e, t) {
                    ...
                    if (l) {
                        var j = "exponential" === u ? {name: "exponential", base: void 0 !== e.base ? e.base : 1} : null;
                        return {
                            kind: "camera",
                            interpolationType: j,
                ...
                function Po(e, t) {
                    var o = e.key, r = e.style, i = e.styleSpec, n = e.value, a = e.objectKey, s = i[t + "_" + e.layerType];
                    if (!s) return [];
 ...
 */
        ...
        "use strict";
        o.r(t);
        var r = o(6), i = o.n(r), n = o(1), a = o.n(n), s = o(2), l = o.n(s), u = o(3), p = o.n(u), c = o(8), d = o.n(c);
        var h = 0;
        ...
        !function () {
            var e, t, o = 60, r = ee, i = "32px ", n = ["monospace", "serif"], a = n.length, s = "wmytzilWMYTZIL@#/&?$%10";
        ...
        var Oe, Ce = function (t, o, r, n, s, u) {
                ...
                if (s) {
                    ...
                    f.crossOrigin = "anonymous", f.onload = function () {
                        c = f, h = [f.width, f.height], f.onload = null
                    }, f.src = s
                }
                for (var y, m = P(t.layers), g = [], v = {}, b = [], x = 0, w = m.length; x < w; ++x) {
                    var k = m[x], j = k.id;
                    if ("string" == typeof o && k.source == o || -1 !== o.indexOf(j)) {
                        var S = k["source-layer"];
                        if (!y) {
                            y = k.source;
                            var T = t.sources[y];
                            if (!T) continue;
                            var z = T.type;
                            if ("vector" !== z && "geojson" !== z) throw new Error('Source "' + y + '" is not of type "vector" or "geojson", but "' + z + '"')
                        }
                        var _ = v[S];
                        _ || (_ = v[S] = []), _.push({layer: k, index: x}), b.push(j);
                        var O = {};
                        O.id = j, O.minzoom = k.minzoom, O.maxzoom = k.maxzoom, g.push(O)
                    }
                    delete ke[j], delete Se[j]
                }
                var R = new p.a, E = new l.a, I = {}, q = {}, L = [], N = function (e, t) {
                    var o = e.getProperties(), s = v[o.layer];
                    if (s) {
                        var f = r.indexOf(t);
                        -1 == (f += 1) && (f = function (e, t) {
                        ...
                        for (var y = ve[e.getGeometry().getType()], m = {
                            properties: o,
                            type: y
                        }, g = -1, b = 0, x = s.length; b < x; ++b) {
                            var w = s[b], k = w.layer, j = k.id, S = k.layout || xe, T = k.paint || xe;
                            if (!("none" === S.visibility || "minzoom" in k && f < k.minzoom || "maxzoom" in k && f >= k.maxzoom)) {
                                var z = k.filter;
                                if (!z || Te(j, z, m, f)) {
                                    var _ = void 0, O = void 0, P = void 0, N = void 0, F = void 0, D = void 0, B = w.index;
                                    if (3 == y && "fill" == k.type) if (O = je(k, "paint", "fill-opacity", f, m), "fill-pattern" in T) {
                                        var U = je(k, "paint", "fill-pattern", f, m);
                                        if (U) {
                                            var G = Ae(U, o);
                                            if (c && n && n[G]) {
                                                (D = L[++g]) && D.getFill() && !D.getStroke() && !D.getText() || (D = L[g] = new a.a({fill: new l.a})), P = D.getFill(), D.setZIndex(B);
                                                var J = G + "." + O, W = q[J];
                                                if (!W) {
                                    ...
                                    } else (_ = ze(je(k, "paint", "fill-color", f, m), O)) && ("fill-outline-color" in T && (F = ze(je(k, "paint", "fill-outline-color", f, m), O)), F || (F = _), (D = L[++g]) && D.getFill() && D.getStroke() && !D.getText() || (D = L[g] = new a.a({
                                        fill: new l.a,
                                        stroke: new p.a
                                    ...
                                    if ((1 == y || 2 == y) && "icon-image" in S) {
                                        ...
                                        if (oe) {
                                            ...
                                            if (c && n && n[Q]) {
                                                ...
                                                if (2 !== y || re) {
                                                    (D = L[++g]) && D.getImage() && !D.getFill() && !D.getStroke() || (D = L[g] = new a.a), D.setGeometry(re);
                                    ...
                                    if (1 == y && "circle-radius" in T) {
                                        (D = L[++g]) && D.getImage() && !D.getFill() && !D.getStroke() || (D = L[g] = new a.a);
                                    ...
                                    if (Ge && O && !te) {
                                        K || ((D = L[++g]) && D.getText() && !D.getFill() && !D.getStroke() || (D = L[g] = new a.a), D.setImage(void 0), D.setGeometry(void 0)), D.getText() || D.setText(Z || new A({padding: [2, 2, 2, 2]})), Z = D.getText();
                                        var Je = je(k, "layout", "text-size", f, m), We = je(k, "layout", "text-font", f, m),
                                            $e = je(k, "layout", "text-line-height", f, m), Ve = i()(u ? u(We) : We, Je, $e),
                                            Ye = S["text-transform"];
                                        ...
                                        Z.setText(Ze), Z.setFont(Ve), Z.setRotation(ae(je(k, "layout", "text-rotate", f, m)));
                        ...
                        return g > -1 ? (L.length = g + 1, L) : void 0
                    }
                };
                return  N
            }, Re = o(19), Me = o.n(Re), Ee = o(7), Ie = o(20), Pe = o(9), qe = o.n(Pe), Le = o(4), Ne = o.n(Le), Fe = o(21),
            De = o.n(Fe), Be = o(22), Ue = o.n(Be), Ge = o(23), Je = o.n(Ge), We = o(5), $e = o(24), Ve = o.n($e),
            Ye = o(10), He = o.n(Ye), Ke = o(11), Ze = o.n(Ke), Xe = o(12), Qe = o.n(Xe), et = o(13), tt = o.n(et),
            ot = o(14), rt = o.n(ot), it = /font-family: ?([^;]*);/, nt = /("|')/g;
        ...
        function ht(e, t, o, r, i) {
            return new Promise(function (n, a) {
                ...
                if (t.sprite) {
                    var c = .5 == (window.devicePixelRatio >= 1.5 ? .5 : 1) ? "@2x" : "", d = dt(t.sprite, r, c + ".json");
        ...
        function yt(e, t) {
            ...
            e.getTargetElement() && r(), e.on(["change:resolution", "change:target"], r)
        }
        ...
        function vt(e, t, o) {
            ...
            var i = new Ze.a({declutter: !0, visible: !1}),
                n = new Qe.a({url: e.tiles ? void 0 : o, tileJSON: e.tiles ? e : void 0}), a = n.on("change", function () {
                    var t = n.getState();
                    if ("ready" === t) {
